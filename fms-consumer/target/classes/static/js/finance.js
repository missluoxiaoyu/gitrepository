...
{"worda":"",
"wordb":"场次数量NO. Match",
"wordc":"原始投注额 TotalInvestment 人民币 RMB",
...
app.controller("fincectrl",function($scope,$http){
	...
	var _get = function(year,month,day,pid){
		$http.get(urlip +'account/summary/queryAll?year='+year+'&month='+month+'&day='+day+'&pid='+pid)
...
//导出功能
	$scope.export=function(){
		...
		if(time =="" || time ==null){
			...
			window.open(urlip +'account/summary/summaryExcel?year='+year+"&month="+month+"&day="+day+"&pid="+pid);
		} 
	}
});
