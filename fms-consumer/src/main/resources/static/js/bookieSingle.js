...
app.controller("glectrl",function($scope,$http){
	var _get = function(year,month,day){
		$http.get(urlip +'account/bookieSingle/queryAll?year='+year+'&month='+month+'&day='+day)
...
//导出功能
	$scope.export=function(){
		...
		if(time =="" || time ==null){
			...
			window.open(urlip +'account/bookieSingle/detailSGLExcel?year='+year+"&month="+month+"&day="+day);
		} 
	}
});
