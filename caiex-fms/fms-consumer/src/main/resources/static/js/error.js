...
var urle = "/errorTicket/refuseTicket";   //拒票
var urlf = "/errorTicket/acceptTicket";   //收票
var urlc = "/errorTicket/cancelTicket";   //取消票
var urld = "/errorTicket/recycleTicket";  //回收票
...
app.controller("erorctrl",function($scope,$http,$location,agService){
	...
	var _get = function(page,size,callback){  
        $http.get(urlip +"errorTicket/getErrorTickets?page="+page +"&size="+size)
